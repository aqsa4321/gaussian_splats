...
# Example usage
subdir = '/home/csslab/Documents/Aqsa/GS/test_gaussian/tandt/truck-16-overlap/mast3r'
images_folder = os.path.join(subdir, 'images')
cam_intrinsics_file = os.path.join(subdir, 'sparse/0/new_cam_intrinsics.txt')
cam_extrinsics_file = os.path.join(subdir, 'sparse/0/new_cam_extrinsics.txt')
